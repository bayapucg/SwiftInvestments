    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-xs-8 text-right m-b-30">
                <a href="<?php echo base_url('testimonial'); ?>" class="btn btn-primary pull-right rounded"><i class="fa fa-plus"></i> Add Team Member</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo isset($list['create_at'])?$list['create_at']:''; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo base_url('testimonial/status/'.base64_encode($list['t_id']).'/'.base64_encode($list['status'])); ?>" class="btn btn-danger">
