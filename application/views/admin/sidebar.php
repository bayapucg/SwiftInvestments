            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li><a href="<?php echo base_url('slider'); ?>">Add Sliders</a></li>
                        <li><a href="<?php echo base_url('slider/lists'); ?>">Sliders List</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li><a href="<?php echo base_url('aboutus/lists'); ?>">About us List</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li><a href="<?php echo base_url('gallery'); ?>">Add Services</a></li>
                        <li><a href="<?php echo base_url('gallery/lists'); ?>">Services List</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li><a href="<?php echo base_url('testimonial'); ?>">Add Team</a></li>
